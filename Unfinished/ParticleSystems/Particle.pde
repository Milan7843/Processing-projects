class Particle {
  ...
  Particle(float x, float y, float vx, float vy, float w, float d, float s, color c, int totLifeTime, boolean fadeEnabled, float fadeAfterFrame) {
    pos = new PVector(x, y);
