...
public class Drawing_program extends PApplet {
...
public void setup() {
  ...
  clearY = height - 150;
  settingsPanelWidth = width*(0.01f*settingsPanelWidth);
  clearWidth = settingsPanelWidth- 40;
  rX = (settingsPanelWidth/8)-(0.5f*sliderWidth);
  gX = (settingsPanelWidth/8)*2-(0.5f*sliderWidth);
  bX = (settingsPanelWidth/8)*3-(0.5f*sliderWidth);
...
public void settingsPanel() {
  ...
  noFill();
  textSize(20);
  text("Brush: ", indicatorX, sizeY + 0.5f*sizeHeight);
  rect(sizeX, sizeY, sizeWidth, sizeHeight);
  fill(r, g, b);
  ellipse(sizeX + 0.75f * settingsPanelWidth, sizeY + 0.5f*sizeHeight, brushSize, brushSize);
  //Colors selector
  noFill();
...
public void mouseWheel(MouseEvent event) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#E50C0C", "Drawing_program" };
    if (passedArgs != null) {
